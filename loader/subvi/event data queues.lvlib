...
<Library LVVersion="15008000">
	...
	<Item Name="Enum data queue_Ctrls.ctl" Type="VI" URL="../Enum data queue_Ctrls.ctl"/>
	<Item Name="Event data  Queues Manager.vi" Type="VI" URL="../Event data  Queues Manager.vi"/>
</Library>
